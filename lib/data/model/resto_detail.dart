...
class Restaurant {
    ...
    factory Restaurant.fromJson(Map<String, dynamic> json) => Restaurant(
        ...
        categories: List<Category>.from((json["categories"] as List)
          ...
          .where((categories) => categories.name != null )),
        menus: Menus.fromJson(json["menus"]),
        rating: json["rating"].toDouble(),
        customerReviews: List<CustomerReview>.from((json["customerReviews"] as List)
          .map((x) => CustomerReview.fromJson(x))
          .where((customerReviews) => 
            customerReviews.name != null &&
            customerReviews.review != null &&
            customerReviews.date != null
          )),
    );
